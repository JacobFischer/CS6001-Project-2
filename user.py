...
class User:
    ...
    def __init__(self, name, curve):
        ...
        Args:
            ...
            curve: the EllipticCurve that this user will use for private/public key generation
        """
        self.name = name
        self.curve = curve

        self._private_key = random.randrange(1, self.curve.n)
        self.public_key = scalar_multiplication(self.curve.point, self._private_key)
    ...
    def generate_shared_secret(self, other_users_public_key):
        ...
        """
        self.shared_secret = scalar_multiplication(other_users_public_key, self._private_key)

    def __str__(self):
        """str override

        Returns:
            str: a human readable string representation of this user and their keys
        """
        return (
"""{self.name}:
